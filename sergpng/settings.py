"""
Django settings for sergpng project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',
            BASE_DIR / 'C:/DEV/Python/DJANGO/serg/django-venv/Lib/site-packages/crispy_bootstrap4/templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'sergpng.wsgi.application'
